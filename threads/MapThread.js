...
function main() {
	...
	this.keyEvent = function (key) {
		...
		case 109: // Numpad -
			...
			print(Math.round(getDistance(me.x, me.y, player.x, player.y)));
			D2Bot.printToConsole(Math.round(getDistance(me.x, me.y, player.x, player.y)))
