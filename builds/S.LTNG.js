...
var AutoBuildTemplate = {
	...
	BuildGoal: {
		...
		Skills: [
			...
			{id: 38, target: 20, from: 50},		// Charged Bolt
			{id: 48, target: 20, from: 50},		// Nova
		]
	},
	...
	2:	{
			Update: function () {
				Config.AttackSkill = [-1, 38, -1, 38, -1, -1, -1];				// Charged Bolt
			}
		},
	...
	18:	{
			Update: function () {
				...
				Config.AttackSkill = [-1, 53, -1, 53, -1, -1, 43];				// Chain Lightning
			}
		},
	...
	60:	{
			Update: function () {
				Config.AttackSkill = [-1, 49, -1, 53, -1, -1, 43];				// Lightning + Chain Lightning
			}
		}
};
