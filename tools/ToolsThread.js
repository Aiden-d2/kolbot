...
function main() {
	...
	this.togglePause = function () {
		var i,	script,
			scripts = ["default.dbj", "tools/townchicken.js"];
	...
	this.keyEvent = function (key) {
		...
		case 110: // Numpad . (reload)
			Messaging.sendToScript("tools/heartbeat.js", "reload");
			break;
	...
	if (Config.QuitListMode > 0 && Config.QuitList instanceof Array) {
		this.initQuitList();
	}
