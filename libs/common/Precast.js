...
var Precast = new function () {
	...
	this.precastCTA = function (force) {
		...
		if (me.gametype === 0 || me.classid === 4 || me.inTown || me.getState(139) || me.getState(140)) {	//260620
			return false;
		}
	...
	this.doPrecast = function (force) {
		...
		case 1: // Sorceress
			...
			if (me.getSkill(52, 0) && (!me.getState(16) || force) && me.charlvl > 54) {	//eom
				this.enchant();
			}
		...
		case 4: // Barbarian - TODO: BO duration
			if (!me.getState(32) || !me.getState(51) || !me.getState(26) || force) {
				...
				delay(me.ping * 2 + 200);	//260810

				if (!me.getState(51) || force) {	//260810
					Skill.cast(155, 0); // Battle Command
				}
