...
if (!isIncluded("common/Misc.js")) { include("common/Misc.js"); };	//260803
	...
	init: function (notify) {	//260803
		try {
			...
			if (Config.AutoBuild.Enabled === true) {
				if (currentScript === "default.dbj" || currentScript === "tools\\autobuildthread.js") {
					if (!isIncluded("common/AutoBuild.js") && include("common/AutoBuild.js")) {
